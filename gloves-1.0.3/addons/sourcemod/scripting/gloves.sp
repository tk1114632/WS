...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_gloves", CommandGlove, ADMFLAG_CUSTOM1, "Gloves menu");
	RegAdminCmd("sm_glove", CommandGlove, ADMFLAG_CUSTOM1, "Gloves menu");
	RegAdminCmd("sm_eldiven", CommandGlove, ADMFLAG_CUSTOM1, "Gloves menu");
